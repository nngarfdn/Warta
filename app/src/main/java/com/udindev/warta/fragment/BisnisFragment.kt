...
import kotlinx.android.synthetic.main.fragment_bisnis.*
...
class BisnisFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (isConnect()) {
            bussinesViewModel.getLoading().observe(this, Observer<Boolean> { isLoading ->
