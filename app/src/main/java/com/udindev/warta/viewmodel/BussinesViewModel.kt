package com.udindev.warta.viewmodel
...
import com.udindev.warta.network.ConfigNetwork
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class BussinesViewModel : ViewModel(){
    ...
    fun loadResults() {
        loading.value = true
        val call = configNetwork.getResultBussinesNews()
